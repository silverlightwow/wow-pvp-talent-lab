window.WOW_PVP_DATA = {
  ...
  "talents": [
    ...
    },
    {
      ...
      "pvp_tooltip": "Your Kill Shot is replaced with Black Arrow.\nBlack Arrow\nYou attempt to finish off a wounded target, dealing (330.98% of Attack Power) Shadow damage and (400% of Attack Power) Shadow damage over 8 sec. Only usable on enemies above 80% health or below 20% health.",
      "tooltip_changed": true,
      "render_status": "CHANGED",
      "changes": [
        {
    ...
    },
    {
      ...
      "pvp_tooltip": "For 15 sec after casting Trueshot, Trueshot is replaced with Moonlight Chakram.\nMoonlight Chakram\nThrow a chakram blessed with moonlight at your current target that will rapidly deal (160.7571% of Attack Power) Physical damage 7 times, bouncing to other targets if they are nearby.\n(1s cooldown)",
      "tooltip_changed": true,
      "render_status": "CHANGED",
      "changes": [
        {
    ...
    },
    {
      ...
      "pvp_tooltip": "Trueshot summons a Dark Minion.\nFor 15 sec after casting Trueshot, Trueshot is replaced with Wailing Arrow.\nWailing Arrow\nFire an enchanted arrow, dealing (1330% of Attack Power) Shadow damage to your target and an additional (665% of Attack Power) Shadow damage to all enemies within 8 yds of your target. Non-Player targets struck by a Wailing Arrow have their spellcasting interrupted and are silenced for 1 sec.\nGrants Deathblow.\n(1s cooldown)",
      "tooltip_changed": true,
      "render_status": "CHANGED",
      "changes": [
        {
  ...
  "abilities": [
    {
      ...
      "diagnostics": [
        {
          "status": "NON_TREE_ABILITY_RESOLVED",
          "source": "simc_exact_build",
          "source_spell_id": 195645,

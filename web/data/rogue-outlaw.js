window.WOW_PVP_DATA = {
  ...
  "talents": [
    {
      ...
      "pvp_tooltip": "30 Energy\nMelee Range\nInstant\n30 sec cooldown\n1 Charge\nAttack with your [\nImproved Shiv\n:\npoisoned blades\n/ off-hand], dealing (117.876% of Attack Power)% Physical damage, dispelling all enrage effects and applying a concentrated form of your\nactive Non-Lethal poison.\nAwards\n1\ncombo points.",
      ...
      "diagnostics": [
        {
          ...
          "text": "Abilities requiring Stealth can be used for 3 sec after Stealth breaks.\nCombat benefits requiring Stealth persist for an additional 3 sec after Stealth breaks.",
          "source": "simc_exact_build",
          "build": "12.1.0.69875",
          "spell_id": 108208,
          "raw": "Name             : Subterfuge (id=108208) [Spell Family (8), Passive] \r\nTalent Entry     : Generic [tree=class, row=9, col=6, max_rank=2, req_points=23]\r\n                 : Effect#1 [op=set, values=(115191, 115191)]\r\n                 : Effect#2 [op=set, values=(3000, 6000)]\r\n                 : Effect#3 [op=set, values=(-100, -100)]\r\n                 : Effect#4 [op=set, values=(2000, 4000)]\r\nClass            : Rogue\r\nSchool           : Physical\r\nSpell Type       : None\r\nLabels           : 16: Class Spells\r\n                 : 20: Rogue Spells\r\n                 : 292\r\nAttributes       : Passive (6), No Aura Cancel (31), Not an Action (92), Not In Spellbook (143), Aura Points On Client (268), Do Not Log on Learn (355), Allow Class Ability Procs (416)\r\nEffects          :\r\n#1 (id=119248)   : Apply Aura (6) | Override Action Spell (Misc w/ Base) (332): Stealth overrides Stealth\r\n                   Base Value: 115191 | Scaled Value: 115191 | Misc Value: 1784 | Trigger Spell: 1784 | Target: Self (1)\r\n                   Affected Spells: Stealth (1784), Stealth (115191)\r\n                   Family Flags: 22\r\n#2 (id=322830)   : Apply Aura (6) | Apply Flat Modifier w/ Label (219): Spell Duration (1)\r\n                   Base Value: 3000 | Scaled Value: 3000 | Misc Value: 1 | Misc Value 2: 2890 (Label) | Target: Self (1)\r\n                   Affected Spells (Label): Subterfuge (115192), Indiscriminate Carnage (385747), Improved Garrote (392401), Take 'em by Surprise (430035)\r\n#3 (id=370946)   : Apply Aura (6) | Add Flat Modifier (107): Spell Effect 5 (33)\r\n                   Base Value: -100 | Scaled Value: -100 | Misc Value: 33 | Target: Self (1)\r\n                   Affected Spells: Vanish (11327)\r\n                   Family Flags: 96\r\n#4 (id=1277119)  : Apply Aura (6) | Dummy (4)\r\n                   Base Value: 2000 | Scaled Value: 2000 | Target: Self (1)\r\nDescription      : Abilities requiring Stealth can be used for $?a137035[${$s4/1000}][${$s2/1000}] sec after Stealth breaks.\r\r\n\r\r\nCombat benefits requiring Stealth persist for an additional $?a137035[${$s4/1000}][${$s2/1000}] sec after Stealth breaks.\r\n\r\n"
        }
      ],
      "has_pvp_mechanics": false,
      "mechanics": [],
  ...
  "source_warnings": [],
  "slug": "rogue-outlaw",
  "generated_at": "2026-09-20T09:51:05.815871+00:00",
  "validation": {
    "talents": 130,
    "changed_tooltips": 11,
